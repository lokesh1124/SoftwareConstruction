...
export const EXERCISE_LIBRARY: Omit<Exercise, 'id' | 'reps'>[] = [
  // CHEST 
  { name: 'Barbell Bench Press', muscles: ['Pectorals', 'Triceps'], tips: 'Retract scapula, touch lower chest.', description: 'The fundamental pushing movement.', videoUrl: 'rxD321l2svE' },
  { name: 'Incline Dumbbell Press', muscles: ['Upper Pectorals', 'Front Delts'], tips: 'Bench at 30 degrees. Tuck elbows.', description: 'Builds upper chest mass.', videoUrl: '0G2_XXbVSnE' },
  { name: 'Decline Bench Press', muscles: ['Lower Pectorals', 'Triceps'], tips: 'Control the descent slowly.', description: 'Isolates the lower chest.', videoUrl: 'rxD321l2svE' },
  { name: 'Cable Crossovers', muscles: ['Pectorals'], tips: 'Squeeze deep at the center.', description: 'Constant tension isolation.', videoUrl: 'taI4XduLpTk' },
  { name: 'Dumbbell Flys', muscles: ['Pectorals'], tips: 'Keep a slight bend in the elbows.', description: 'Excellent chest stretching movement.', videoUrl: '0G2_XXbVSnE' },
  { name: 'Pec Deck Machine', muscles: ['Pectorals'], tips: 'Keep elbows high, squeeze chest.', description: 'Machine isolation for massive pumps.', videoUrl: 'taI4XduLpTk' },
  { name: 'Push-ups', muscles: ['Pectorals', 'Triceps', 'Core'], tips: 'Elbows at 45 degrees, core tight.', description: 'Classic bodyweight builder.', videoUrl: 'IODxDxX7oi4' },
  { name: 'Weighted Dips', muscles: ['Lower Pectorals', 'Triceps'], tips: 'Lean forward to hit chest.', description: 'Heavy compound pushing power.', videoUrl: '2z8JmcrW-As' },
  { name: 'Guillotine Press', muscles: ['Upper Pectorals'], tips: 'Bar to neck, wide grip.', description: 'Advanced upper chest targeted lift.', videoUrl: 'rxD321l2svE' },
  { name: 'Svend Press', muscles: ['Inner Pectorals'], tips: 'Squeeze plates together hard.', description: 'Activates the center chest.', videoUrl: '0G2_XXbVSnE' },
  { name: 'Floor Press', muscles: ['Triceps', 'Pectorals'], tips: 'Pause when triceps hit floor.', description: 'Improves lockout power.', videoUrl: 'rxD321l2svE' },
  { name: 'Dumbbell Pullover', muscles: ['Pectorals', 'Lats'], tips: 'Keep hips low, stretch deep.', description: 'Expands the ribcage.', videoUrl: '0G2_XXbVSnE' },
  { name: 'Landmine Chest Press', muscles: ['Upper Pectorals', 'Front Delts'], tips: 'Squeeze hands together at the top.', description: 'Standing upper chest builder.', videoUrl: '0G2_XXbVSnE' },
  { name: 'Hex Press', muscles: ['Inner Pectorals', 'Triceps'], tips: 'Crush dumbbells together throughout.', description: 'Forces massive chest contraction.', videoUrl: '0G2_XXbVSnE' },
  { name: 'Spoto Press', muscles: ['Pectorals'], tips: 'Pause two inches above chest.', description: 'Builds sticking point strength.', videoUrl: 'rxD321l2svE' },
  { name: 'Suspension Push-ups', muscles: ['Pectorals', 'Core'], tips: 'Keep core perfectly rigid.', description: 'Adds brutal instability to the pushup.', videoUrl: 'IODxDxX7oi4' },
  { name: 'Band Resisted Push-ups', muscles: ['Pectorals', 'Triceps'], tips: 'Explode up against the band.', description: 'Develops raw pressing power.', videoUrl: 'IODxDxX7oi4' },
  { name: 'Around The Worlds', muscles: ['Pectorals'], tips: 'Light weight, focus on stretch.', description: 'Full rotational chest mobility.', videoUrl: 'taI4XduLpTk' },
  { name: 'Low Cable Crossovers', muscles: ['Upper Pectorals'], tips: 'Pull upwards from the floor.', description: 'Targets the clavicular head.', videoUrl: 'taI4XduLpTk' },
  { name: 'Machine Chest Press', muscles: ['Pectorals'], tips: 'Drive through your palms.', description: 'Safe mechanical overload.', videoUrl: 'rxD321l2svE' },

  // BACK 
  { name: 'Barbell Deadlift', muscles: ['Lower Back', 'Hamstrings', 'Glutes'], tips: 'Keep bar touching shins.', description: 'Ultimate posterior chain strength.', videoUrl: 'op9kVnSso6Q' },
  { name: 'Pull-up', muscles: ['Latissimus Dorsi', 'Biceps'], tips: 'Chest to bar. Full stretch.', description: 'Builds massive back width.', videoUrl: 'eGo4IYONTA' },
  { name: 'Barbell Row', muscles: ['Rhomboids', 'Lats'], tips: 'Torso parallel, pull to waist.', description: 'Thickens the entire mid-back.', videoUrl: '9fI63yA48eA' },
  { name: 'Lat Pulldown', muscles: ['Latissimus Dorsi'], tips: 'Arch back, pull to upper chest.', description: 'Machine pull-up alternative.', videoUrl: 'JGeRYlzPcRw' },
  { name: 'Seated Cable Row', muscles: ['Rhomboids', 'Middle Back'], tips: 'Squeeze shoulder blades.', description: 'Great for posture.', videoUrl: 'GZbfZ033f74' },
  { name: 'T-Bar Row', muscles: ['Middle Back', 'Lats'], tips: 'Keep lower back completely flat.', description: 'Heavy back isolation.', videoUrl: '9fI63yA48eA' },
  { name: 'Meadows Row', muscles: ['Lats'], tips: 'Stagger stance, pull high.', description: 'Unilateral lat development.', videoUrl: '9fI63yA48eA' },
  { name: 'Rack Pulls', muscles: ['Lower Back', 'Traps'], tips: 'Pull from the knee up.', description: 'Overloads the top of the deadlift.', videoUrl: 'op9kVnSso6Q' },
  { name: 'Dumbbell Row', muscles: ['Lats'], tips: 'Pull dumbbell to the hip.', description: 'Isolates each lat individually.', videoUrl: 'GZbfZ033f74' },
  { name: 'Straight Arm Pulldown', muscles: ['Lats'], tips: 'Keep arms slightly bent.', description: 'Isolates lats without bicep use.', videoUrl: 'JGeRYlzPcRw' },
  { name: 'Chin-ups', muscles: ['Lats', 'Biceps'], tips: 'Underhand grip, chin over bar.', description: 'More bicep dominant back pull.', videoUrl: 'eGo4IYONTA' },
  { name: 'Good Mornings', muscles: ['Lower Back', 'Hamstrings'], tips: 'Hinge at hips, keep back flat.', description: 'Strengthens the spinal erectors.', videoUrl: 'JCXUYuzwNrM' },
  { name: 'Renegade Row', muscles: ['Lats', 'Core'], tips: 'Keep hips from swaying.', description: 'Core and back combination.', videoUrl: 'GZbfZ033f74' },
  { name: 'Inverted Row', muscles: ['Mid Back'], tips: 'Body straight, pull to sternum.', description: 'Bodyweight horizontal pull.', videoUrl: '9fI63yA48eA' },
  { name: 'Pendlay Row', muscles: ['Rhomboids', 'Lats'], tips: 'Reset the bar on the floor every rep.', description: 'Explosive back builder from dead stop.', videoUrl: '9fI63yA48eA' },
  { name: 'Yates Row', muscles: ['Lats', 'Traps'], tips: 'Underhand grip, torso at 45 degrees.', description: 'Dorian Yates signature back move.', videoUrl: '9fI63yA48eA' },
  { name: 'Kroc Row', muscles: ['Lats', 'Grip'], tips: 'Heavy weight, high reps.', description: 'Brutal unilateral dumbbell row.', videoUrl: 'GZbfZ033f74' },
  { name: 'Seal Row', muscles: ['Mid Back'], tips: 'Lie face down on a tall bench.', description: 'Completely eliminates momentum.', videoUrl: 'GZbfZ033f74' },
  { name: 'V-Bar Pulldown', muscles: ['Lats (Lower)'], tips: 'Pull to the lowest point of your chest.', description: 'Forces extreme lower lat stretching.', videoUrl: 'JGeRYlzPcRw' },
  { name: 'Wide Grip Pull-up', muscles: ['Latissimus Dorsi (Outer)'], tips: 'Hands far past shoulders.', description: 'Maximal back widening focus.', videoUrl: 'eGo4IYONTA' },
  { name: 'Neutral Grip Pull-up', muscles: ['Lats', 'Brachialis'], tips: 'Palms facing each other.', description: 'Safest pulling angle for joints.', videoUrl: 'eGo4IYONTA' },
  { name: 'Superman Extensions', muscles: ['Lower Back'], tips: 'Hold contraction at the top.', description: 'Bodyweight spinal extension.', videoUrl: 'JCXUYuzwNrM' },

  // SHOULDERS & TRAPS
  { name: 'Standing Overhead Press', muscles: ['Deltoids', 'Triceps'], tips: 'Squeeze glutes, press straight up.', description: 'Primary shoulder mass builder.', videoUrl: 'qaBf2S4B0sI' },
  { name: 'Seated Dumbbell Press', muscles: ['Front Delts'], tips: 'Bench at 90 degrees.', description: 'Takes momentum out of the press.', videoUrl: 'qaBf2S4B0sI' },
  { name: 'Dumbbell Lateral Raises', muscles: ['Lateral Delts'], tips: 'Pour the water at the top.', description: 'Builds wide capping shoulders.', videoUrl: 'WQQO_0UIV8Y' },
  { name: 'Cable Lateral Raises', muscles: ['Lateral Delts'], tips: 'Pull from behind the back.', description: 'Constant tension on the side delt.', videoUrl: 'WQQO_0UIV8Y' },
  { name: 'Face Pulls', muscles: ['Rear Delts', 'Rotator Cuffs'], tips: 'Pull to forehead level.', description: 'Crucial for shoulder health.', videoUrl: 'V8d6XpoiyDk' },
  { name: 'Reverse Pec Deck', muscles: ['Rear Delts'], tips: 'Lead with the pinkies.', description: 'Isolates the posterior deltoid.', videoUrl: 'V8d6XpoiyDk' },
  { name: 'Front Raises', muscles: ['Front Delts'], tips: 'Raise to eye level only.', description: 'Isolates the anterior deltoid.', videoUrl: 'WQQO_0UIV8Y' },
  { name: 'Barbell Shrugs', muscles: ['Trapezius'], tips: 'Elevate straight up, pause 1s.', description: 'Thickens the upper back/neck.', videoUrl: 'cJRVVxmytaM' },
  { name: 'Dumbbell Shrugs', muscles: ['Trapezius'], tips: 'Keep arms straight, squeeze traps.', description: 'Avoid rolling the shoulders.', videoUrl: 'cJRVVxmytaM' },
  { name: 'Upright Row', muscles: ['Lateral Delts', 'Traps'], tips: 'Pull elbows higher than wrists.', description: 'Compound movement for shoulder width.', videoUrl: 'WQQO_0UIV8Y' },
  { name: 'Lu Raises', muscles: ['Full Deltoid'], tips: 'Full range of motion overhead.', description: 'Olympic lifter variation of raises.', videoUrl: 'WQQO_0UIV8Y' },
  { name: 'Arnold Press', muscles: ['Front Delts', 'Lateral Delts'], tips: 'Rotate palms on the way up.', description: 'Hits all heads of the deltoid.', videoUrl: 'qaBf2S4B0sI' },
  { name: 'Z Press', muscles: ['Deltoids', 'Core'], tips: 'Sit perfectly upright on floor.', description: 'Brutal no-momentum shoulder press.', videoUrl: 'qaBf2S4B0sI' },
  { name: 'Bradford Press', muscles: ['Deltoids'], tips: 'Press front to back over head.', description: 'Constant tension shoulder builder.', videoUrl: 'qaBf2S4B0sI' },
  { name: 'Landmine Shoulder Press', muscles: ['Front Delts'], tips: 'Lean into the press.', description: 'Great for shoulder joint health.', videoUrl: 'qaBf2S4B0sI' },
  { name: 'Upright Cable Row', muscles: ['Lateral Delts'], tips: 'Use a wide grip on the bar.', description: 'Smoother resistance than barbells.', videoUrl: 'WQQO_0UIV8Y' },
  { name: 'Front Cable Raise', muscles: ['Front Delts'], tips: 'Face away from the machine.', description: 'Deep stretch on the front delt.', videoUrl: 'WQQO_0UIV8Y' },
  { name: 'Band Pull-Aparts', muscles: ['Rear Delts', 'Traps'], tips: 'Keep arms perfectly straight.', description: 'High volume postural correction.', videoUrl: 'V8d6XpoiyDk' },
  { name: 'Y-Raises', muscles: ['Lower Traps'], tips: 'Thumbs up, form a Y.', description: 'Targets the lower traps and stabilizers.', videoUrl: 'WQQO_0UIV8Y' },
  { name: 'Machine Shoulder Press', muscles: ['Deltoids'], tips: 'Keep back flat against the pad.', description: 'Isolated heavy pressing.', videoUrl: 'qaBf2S4B0sI' },

  // ARMS 
  { name: 'Barbell Bicep Curls', muscles: ['Biceps Brachii'], tips: 'Keep elbows pinned to sides.', description: 'Heavy mass builder for biceps.', videoUrl: 'i1YgFZB6alI' },
  { name: 'Hammer Curls', muscles: ['Brachialis', 'Forearms'], tips: 'Neutral grip throughout.', description: 'Thickens the side of the arm.', videoUrl: 'TwD-YGVP4Bk' },
  { name: 'Preacher Curls', muscles: ['Biceps Brachii'], tips: 'Full extension at the bottom.', description: 'Isolates the bicep peak.', videoUrl: 'i1YgFZB6alI' },
  { name: 'Concentration Curls', muscles: ['Bicep Peak'], tips: 'Rest elbow on inner thigh.', description: 'Strict bicep isolation.', videoUrl: 'i1YgFZB6alI' },
  { name: 'Spider Curls', muscles: ['Bicep Short Head'], tips: 'Lean over incline bench.', description: 'Prevents any momentum usage.', videoUrl: 'i1YgFZB6alI' },
  { name: 'Tricep Pushdowns', muscles: ['Triceps'], tips: 'Lock elbows at your side.', description: 'Builds tricep sweep.', videoUrl: '2-LAMcpzODU' },
  { name: 'Overhead Tricep Extension', muscles: ['Triceps (Long Head)'], tips: 'Keep elbows pointing up.', description: 'Stretches the long head of triceps.', videoUrl: 'd_KZxkY_0cM' },
  { name: 'Skull Crushers', muscles: ['Triceps'], tips: 'Lower to forehead slowly.', description: 'Massive heavy tricep builder.', videoUrl: 'd_KZxkY_0cM' },
  { name: 'Close-Grip Bench Press', muscles: ['Triceps', 'Pectorals'], tips: 'Hands shoulder-width apart.', description: 'Compound pressing for tricep thickness.', videoUrl: 'rxD321l2svE' },
  { name: 'JM Press', muscles: ['Triceps'], tips: 'Bar path straight to chin.', description: 'Powerlifting variation of skull crushers.', videoUrl: 'd_KZxkY_0cM' },
  { name: 'Wrist Curls', muscles: ['Forearms'], tips: 'Rest arms on bench, curl wrists.', description: 'Isolates flexors.', videoUrl: 'TwD-YGVP4Bk' },
  { name: 'Reverse Curls', muscles: ['Brachioradialis'], tips: 'Pronated overhand grip.', description: 'Develops thick upper forearms.', videoUrl: 'TwD-YGVP4Bk' },
  { name: 'Incline Dumbbell Curls', muscles: ['Biceps (Long Head)'], tips: 'Let arms hang straight down behind body.', description: 'Maximal stretch on the biceps.', videoUrl: 'i1YgFZB6alI' },
  { name: 'Zottman Curls', muscles: ['Biceps', 'Forearms'], tips: 'Curl supinated, lower pronated.', description: 'Complete arm development.', videoUrl: 'TwD-YGVP4Bk' },
  { name: 'Waiter Curls', muscles: ['Bicep Peak'], tips: 'Hold top of one dumbbell with both hands.', description: 'Intense short head contraction.', videoUrl: 'i1YgFZB6alI' },
  { name: 'Cable Rope Curls', muscles: ['Brachialis'], tips: 'Pull rope apart at the top.', description: 'Constant tension hammer variant.', videoUrl: 'TwD-YGVP4Bk' },
  { name: 'Drag Curls', muscles: ['Biceps'], tips: 'Drag bar straight up torso.', description: 'Eliminates front delt involvement.', videoUrl: 'i1YgFZB6alI' },
  { name: 'Bicep 21s', muscles: ['Biceps'], tips: '7 bottom, 7 top, 7 full reps.', description: 'Extreme time-under-tension pump.', videoUrl: 'i1YgFZB6alI' },
  { name: 'Tate Press', muscles: ['Triceps'], tips: 'Dumbbells pointing at chest.', description: 'Hits the triceps right above the elbow.', videoUrl: 'd_KZxkY_0cM' },
  { name: 'Tricep Kickbacks', muscles: ['Triceps'], tips: 'Extend fully and pause 1s.', description: 'Total isolation at the peak.', videoUrl: '2-LAMcpzODU' },
  { name: 'French Press', muscles: ['Triceps (Long Head)'], tips: 'Bar behind head while seated.', description: 'A seated skull crusher variation.', videoUrl: 'd_KZxkY_0cM' },
  { name: 'Rolling Tricep Extensions', muscles: ['Triceps'], tips: 'Roll elbows back to stretch lats.', description: 'Powerful compound tricep lift.', videoUrl: 'd_KZxkY_0cM' },
  { name: 'Diamond Push-ups', muscles: ['Triceps', 'Inner Chest'], tips: 'Hands form a diamond.', description: 'Incredible bodyweight tricep pump.', videoUrl: 'IODxDxX7oi4' },
  { name: 'Bench Dips', muscles: ['Triceps'], tips: 'Keep back close to the bench.', description: 'Bodyweight tricep burnout.', videoUrl: '2z8JmcrW-As' },

  // LEGS 
  { name: 'Barbell Back Squat', muscles: ['Quads', 'Glutes', 'Core'], tips: 'Break at hips/knees together.', description: 'King of all leg exercises.', videoUrl: 'gcNh17Ckjgg' },
  { name: 'Front Squat', muscles: ['Quads', 'Core'], tips: 'Keep elbows incredibly high.', description: 'Forces vertical torso and hits quads hard.', videoUrl: 'vENQp3XnXaY' },
  { name: 'Hack Squat', muscles: ['Quads'], tips: 'Place feet low for quad sweep.', description: 'Machine isolation for deep quads.', videoUrl: 'vENQp3XnXaY' },
  { name: 'Bulgarian Split Squat', muscles: ['Quads', 'Glutes'], tips: 'Back foot on bench, front does work.', description: 'The ultimate unilateral leg movement.', videoUrl: '2C-uNgKwPLE' },
  { name: 'Leg Press', muscles: ['Quads', 'Hamstrings'], tips: 'Do not lock out knees hard.', description: 'Heavy overload without spinal compression.', videoUrl: 'yZmx_Ac3880' },
  { name: 'Sissy Squat', muscles: ['Quads'], tips: 'Lean back, knees forward.', description: 'Intense quad stretch and activation.', videoUrl: 'YyvSfVjQeL0' },
  { name: 'Leg Extension', muscles: ['Quads'], tips: 'Squeeze at peak contraction.', description: 'Deep structural cuts in front leg.', videoUrl: 'YyvSfVjQeL0' },
  ...
  { name: 'Stiff-Leg Deadlift', muscles: ['Hamstrings'], tips: 'Legs entirely straight.', description: 'Focuses entirely on hamstring stretch.', videoUrl: 'JCXUYuzwNrM' },
  { name: 'Hip Thrust', muscles: ['Glutes'], tips: 'Drive through heels, squeeze loud.', description: 'Isolates glutes with maximum tension.', videoUrl: 'xDoeTFB_tJA' },
  { name: 'Glute Kickbacks', muscles: ['Glutes'], tips: 'Kick straight back, no spine bend.', description: 'Cable isolation for upper glutes.', videoUrl: 'xDoeTFB_tJA' },
  ...
  { name: 'Walking Lunges', muscles: ['Quads', 'Glutes'], tips: 'Long strides for glutes, short for quads.', description: 'Dynamic leg mass.', videoUrl: '2C-uNgKwPLE' },
  ...
  { name: 'Adductor Machine', muscles: ['Inner Thighs'], tips: 'Controlled squeeze inward.', description: 'Leg stability.', videoUrl: 'yZmx_Ac3880' },
  { name: 'Abductor Machine', muscles: ['Outer Thighs', 'Glutes'], tips: 'Drive knees outwards.', description: 'Outer hip development.', videoUrl: 'xDoeTFB_tJA' },
  { name: 'Goblet Squat', muscles: ['Quads', 'Core'], tips: 'Hold dumbbell vertically at chest.', description: 'Great for squat depth and form.', videoUrl: 'vENQp3XnXaY' },
  { name: 'Zercher Squat', muscles: ['Quads', 'Core'], tips: 'Hold bar in the crook of elbows.', description: 'Brutal combination of leg and core work.', videoUrl: 'vENQp3XnXaY' },
  { name: 'Jefferson Squat', muscles: ['Quads', 'Glutes'], tips: 'Straddle the barbell.', description: 'Old school asymmetrical strength.', videoUrl: 'gcNh17Ckjgg' },
  { name: 'Dumbbell Step-Ups', muscles: ['Quads', 'Glutes'], tips: 'Drive off the elevated foot.', description: 'Unilateral quad overload.', videoUrl: '2C-uNgKwPLE' },
  { name: 'Split Squat Jumps', muscles: ['Quads', 'Cardio'], tips: 'Explode and switch legs in air.', description: 'Plyometric leg power.', videoUrl: '2C-uNgKwPLE' },
  { name: 'Pistol Squats', muscles: ['Quads', 'Balance'], tips: 'Extend one leg straight out.', description: 'Elite bodyweight leg strength.', videoUrl: 'gcNh17Ckjgg' },
  { name: 'Nordic Hamstring Curls', muscles: ['Hamstrings'], tips: 'Control descent as much as possible.', description: 'Incredible eccentric hamstring strength.', videoUrl: 'F488kNIv3_Q' },
  { name: 'Glute Ham Raise', muscles: ['Hamstrings', 'Glutes'], tips: 'Squeeze glutes to pull body up.', description: 'Posterior chain mastery.', videoUrl: 'F488kNIv3_Q' },
  { name: 'Reverse Lunges', muscles: ['Quads', 'Glutes'], tips: 'Step back, keep front shin vertical.', description: 'Safer on the knees than forward lunges.', videoUrl: '2C-uNgKwPLE' },
  { name: 'Curtsy Lunges', muscles: ['Gluteus Medius'], tips: 'Step diagonally behind.', description: 'Targets the outer glute specifically.', videoUrl: 'xDoeTFB_tJA' },
  { name: 'Donkey Calf Raises', muscles: ['Gastrocnemius'], tips: 'Hinge over, raise heels.', description: 'Hits the calves from a stretched ham position.', videoUrl: 'gwLzBJYoWlI' },
  { name: 'Single Leg Calf Raises', muscles: ['Calves'], tips: 'Hold onto a wall for balance.', description: 'Fixes unilateral calf imbalances.', videoUrl: 'gwLzBJYoWlI' },
  { name: 'Seated Tibialis Raises', muscles: ['Tibialis Anterior'], tips: 'Pull toes straight up to ceiling.', description: 'Develops the front of the shin.', videoUrl: 'gwLzBJYoWlI' },
  { name: 'Jump Rope', muscles: ['Calves', 'Cardio'], tips: 'Stay light on the balls of your feet.', description: 'Spring-loaded calf conditioning.', videoUrl: 'gwLzBJYoWlI' },

  // CORE, CONDITIONING, & MOBILITY 
  { name: 'Plank', muscles: ['Core', 'Transverse Abdominis'], tips: 'Hollow body, straight line.', description: 'Static deep core strength.', videoUrl: 'pSHjTRCQx8' },
  { name: 'Russian Twists', muscles: ['Obliques'], tips: 'Rotate your chest, not just arms.', description: 'Rotational core power.', videoUrl: 'wkD8rjkodUI' },
  { name: 'Mountain Climbers', muscles: ['Core', 'Cardio'], tips: 'Keep hips low.', description: 'High intensity conditioning.', videoUrl: 'nmwgirgXLYM' },
  { name: 'Hanging Leg Raises', muscles: ['Lower Abs'], tips: 'No swinging, strict pull.', description: 'Ultimate lower ab development.', videoUrl: 'wkD8rjkodUI' },
  { name: 'Dragon Flags', muscles: ['Core'], tips: 'Only shoulders touch bench.', description: 'Bruce Lee’s extreme core move.', videoUrl: 'pSHjTRCQx8' },
  { name: 'Ab Wheel Rollout', muscles: ['Core'], tips: 'Do not arch lower back.', description: 'Incredible anti-extension core drill.', videoUrl: 'pSHjTRCQx8' },
  { name: 'V-Ups', muscles: ['Abs'], tips: 'Touch toes at the apex.', description: 'Explosive core flexion.', videoUrl: 'wkD8rjkodUI' },
  { name: 'Bicycle Crunches', muscles: ['Obliques', 'Abs'], tips: 'Elbow to opposite knee rapidly.', description: 'Dynamic full ab targeting.', videoUrl: 'nmwgirgXLYM' },
  { name: 'Kettlebell Swings', muscles: ['Glutes', 'Core', 'Cardio'], tips: 'Pop the hips, don’t raise arms.', description: 'Explosive HIIT standard.', videoUrl: 'JCXUYuzwNrM' },
  { name: 'Burpees', muscles: ['Full Body', 'Cardio'], tips: 'Chest to floor.', description: 'Maximum effort conditioning.', videoUrl: 'IODxDxX7oi4' },
  { name: 'L-Sit', muscles: ['Core', 'Hip Flexors'], tips: 'Keep legs locked straight out.', description: 'Gymnastic static strength.', videoUrl: 'pSHjTRCQx8' },
  { name: 'Hollow Body Hold', muscles: ['Core'], tips: 'Press low back entirely into floor.', description: 'Essential core bracing movement.', videoUrl: 'pSHjTRCQx8' },
  { name: 'Suitcase Carries', muscles: ['Obliques', 'Grip'], tips: 'Hold one heavy dumbbell, walk straight.', description: 'Dynamic anti-lateral flexion.', videoUrl: 'pSHjTRCQx8' },
  { name: 'Farmers Walk', muscles: ['Grip', 'Traps', 'Core'], tips: 'Shoulders back, chest up.', description: 'Raw whole-body work capacity.', videoUrl: 'op9kVnSso6Q' },
  { name: 'Pallof Press', muscles: ['Obliques'], tips: 'Press cable straight out from chest.', description: 'Anti-rotation core stability.', videoUrl: 'wkD8rjkodUI' },
  { name: 'Cable Woodchoppers', muscles: ['Obliques'], tips: 'Rotate through the hips.', description: 'Explosive rotational power.', videoUrl: 'wkD8rjkodUI' },
  { name: 'Dead Bug', muscles: ['Core'], tips: 'Opposite arm and leg extend slowly.', description: 'Perfect core coordination.', videoUrl: 'pSHjTRCQx8' },
  { name: 'Bird Dog', muscles: ['Spinal Erectors'], tips: 'Maintain a perfectly flat back.', description: 'Essential spine stabilization.', videoUrl: 'JCXUYuzwNrM' },
  { name: 'Side Plank', muscles: ['Obliques'], tips: 'Do not let hips sag.', description: 'Lateral core endurance.', videoUrl: 'pSHjTRCQx8' },
  { name: 'Reverse Crunches', muscles: ['Lower Abs'], tips: 'Roll pelvis off the floor.', description: 'Targets the difficult lower abs.', videoUrl: 'wkD8rjkodUI' },
  { name: 'Flutter Kicks', muscles: ['Lower Abs', 'Hip Flexors'], tips: 'Keep legs hovering just over floor.', description: 'Continuous tension on lower core.', videoUrl: 'wkD8rjkodUI' },
  { name: 'Cat Cow', muscles: ['Spine Mobility'], tips: 'Breathe smoothly with the arch.', description: 'Great warm-up for deadlifts.', videoUrl: 'JCXUYuzwNrM' },
  { name: 'Thread the Needle', muscles: ['Thoracic Spine'], tips: 'Reach as far through as possible.', description: 'Increases thoracic rotation.', videoUrl: 'WQQO_0UIV8Y' },
  { name: '90/90 Stretch', muscles: ['Hip Mobility'], tips: 'Keep chest tall, fold over front leg.', description: 'Crucial for squat depth mechanics.', videoUrl: 'gcNh17Ckjgg' },
  { name: 'Couch Stretch', muscles: ['Quads', 'Hip Flexors'], tips: 'Squeeze glute of the knee on floor.', description: 'Reverses the effects of sitting.', videoUrl: 'vENQp3XnXaY' },
  { name: 'Worlds Greatest Stretch', muscles: ['Full Body Mobility'], tips: 'Open chest to the ceiling.', description: 'Hits hips, t-spine, and ankles.', videoUrl: 'JCXUYuzwNrM' },
  { name: 'Jumping Jacks', muscles: ['Cardio'], tips: 'Keep a fast rhythm.', description: 'Classic total body warm up.', videoUrl: 'nmwgirgXLYM' },
  { name: 'Jump Squats', muscles: ['Quads', 'Plyos'], tips: 'Absorb the landing softly.', description: 'Lower body explosive power.', videoUrl: 'gcNh17Ckjgg' }
];
